...
public class SimpleIterationsCalculate
{
    ...
    {
        var simpleIteration1 = new SimpleIterations(-4.0f, 0.000001f,f1, df1);
        var simpleIteration2 = new SimpleIterations(-1.5f, 0.000001f, f1, df1);
        var simpleIteration3 = new SimpleIterations(0.5f, 0.000001f, f1, df1);
        var simpleIteration4 = new SimpleIterations(4.0f, 0.000001f, f1, df1);
        var list2 = new List<SimpleIterations>{ simpleIteration1, simpleIteration2, simpleIteration3, simpleIteration4 };
    ...
    {
        var simpleIteration1 = new SimpleIterations(1f, 0.00001f,f2, df2);
